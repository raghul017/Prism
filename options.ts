...
export const themes: Record<string, { background: string; theme: string; glow: string }> = {
  hyper: {
    background: "bg-gradient-to-br from-fuchsia-500 via-red-600 to-orange-400",
    theme:
      "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.8.0/styles/atom-one-dark.min.css",
    glow: "rgba(240, 46, 170, 0.4)", // fuchsia/red
  },
  oceanic: {
  ...
  peach: {
    ...
    glow: "rgba(251, 113, 133, 0.4)", // rose
  },
  flamingo: {
  ...
  gotham: {
    ...
    glow: "rgba(100, 116, 139, 0.4)", // gray
  },
  ice: {
